...
#if LL_WINDOWS || LL_MESA_HEADLESS || LL_SDL_WINDOW || LL_LINUX || __FreeBSD__
 //----------------------------------------------------------------------------
...
#if (LL_LINUX || __FreeBSD__) && LL_X11 && !LL_MESA_HEADLESS
...
#if (LL_LINUX || __FreeBSD__) && LL_WAYLAND && !LL_MESA_HEADLESS
